...
parser = argparse.ArgumentParser(description='Evaluate DPO / policy checkpoint on GSM8K or MATH')
parser.add_argument('--ref_model_id', '--model_id', dest='ref_model_id', required=True, type=str,
                    help='policy checkpoint or HF model id')

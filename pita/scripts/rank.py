...
def apply_template(text, tokenizer):
    # Upstream passed add_generate_prompt (a typo for add_generation_prompt), so the
    # kwarg was swallowed and it recovered the prefix by splitting on a dummy reply.
...
def main(args):
    ...
    # Upstream matched substrings of the model name here and raised for anything outside
    # mistral / llama-3 / gemma-2. The tokenizer ships with the model.
